...
builds a read-only ``SELECT`` (see :mod:`pgcarter.analyzer.queries`) and runs it
...
from pgcarter.analyzer.rules import AnalysisContext, ColumnCheck, constraint_columns, register
